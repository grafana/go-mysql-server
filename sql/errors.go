...
var (
	...
	// ErrFileReadsDisabled is returned when LOAD_FILE is used but file reads are disabled
	ErrFileReadsDisabled = errors.NewKind("file read operations (LOAD_FILE) are disabled")
